...
절댓값 순 정렬
n개의 숫자가 주어질 때, 이를 절댓값을 기준으로 오름차순 정렬하는 프로그램을 작성하세요. 
만약 두 수의 절댓값이 같다면, 더 작은 숫자가 앞에 위치하게 됩니다. 이 실습 문제는 Quick sort로 구현해주세요.
...
힌트) Quick sort(퀵 정렬)이 무엇인지 잘 기억이 나지 않는다면 1장 수업의 “이론4. 퀵정렬”을 복습해보세요.
'''
